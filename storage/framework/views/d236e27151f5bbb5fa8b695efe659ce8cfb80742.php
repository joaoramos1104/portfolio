        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="Profile" role="tabpanel" aria-labelledby="Profile-tab">
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 m-auto mt-2 text-center text-white">
                                ...
                                <div class="container">
                                    <form action="/admin/education/" method="post">
                                        ...
                                        <div class="row p-1">
                                            ...
                                            <div class="mb-3 col-md-6 col-sm-12">
                                                <label for="institution" class="form-label">Instituição</label>
                                                <input type="text" class="form-control" name="institution" id="institution" value="" placeholder="Example: Estácio de Sá">
                                            </div>
                                            <div class="mb-3 col-md-6 col-sm-12">
                                                <label for="course" class="form-label">Curso</label>
                                                <input type="text" class="form-control" name="course" id="cource" value="" placeholder="Example: Sistema da Informação">
                                            </div>
                                            <div class="mb-3 col-md-6 col-sm-12">
                                                <label for="type_course" class="form-label">Nível do Curso</label>
                                                <input type="text" class="form-control" name="type_course" id="type_course" value="" placeholder="Example: Bacharelado ou Tecnologo">
                                            </div>
                                            <div class="mb-3 col-md-6 col-sm-12">
                                                <label for="time_course" class="form-label">Período</label>
                                                <input type="text" class="form-control" name="time_course" id="time_course" value="" placeholder="Example: 2020 - 2025">
                                            </div>
                                            <div class="mb-3 col-6">
                                ...
                                <div class="container">
                                    <form action="/admin/experiences/" method="post">
                                        ...
                                        <div class="row p-1">
                                            ...
                                            <div class="mb-3 col-md-6 col-sm-12">
                                                <label for="job_title" class="form-label">Cargo | Função</label>
                                                <input type="text" class="form-control" name="job_title" id="job_title" value="" placeholder="Example: Web Developer">
                                            </div>
                                            <div class="mb-3 col-md-6 col-sm-12">
                                                <label for="link_reference" class="form-label">Link Referência</label>
                                                <input type="text" class="form-control" name="link_reference" id="link_reference" value="" placeholder="Example: Linkedin">
                                            </div>
                                            <div class="mb-3 p-1">
                                                <label for="textareaExperienceNew" class="form-label text-white">Descrição</label>
                                                <textarea class="form-control" name="description_experience" id="textareaExperienceNew" rows="5" placeholder="Fale um pouco de sua experiência."></textarea>
                                            </div>
                                        </div>
                                        <div class="m-auto justify-content-center">
                                            <button type="button" id="limparTextareaExperience" class="btn btn-warning">Cancelar</button>
                                            <button type="submit" class="btn btn-primary">Salvar</button>
                                        </div>
                                    </form>
                                </div>
    ...
    <div class="modal-fullscreen modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php $__currentLoopData = $profiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <form action="/admin/profile/<?php echo e($profile->id); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <div class="row p-3">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Usuários\joaor\Área de Trabalho\portifolio\resources\views//admin/admin.blade.php ENDPATH**/ ?>