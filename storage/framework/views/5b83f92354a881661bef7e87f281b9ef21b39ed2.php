                ...
                <div class="tab-pane fade show active" id="Profile" role="tabpanel" aria-labelledby="Profile-tab">
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 m-auto text-center text-white">
                            <span class=""><img class="img-fluid img-profile rounded-circle mx-auto mb-2" src=" /storage/<?php echo e($profile->img_profile); ?>" alt="..." /></span>
                            <h3><?php echo e($profile->name); ?> | <?php echo e($profile->tag_name); ?></h3>
                            <p><?php echo e($profile->description); ?></p>
                        </div>
                        <div class="col-md-7 d-sm-none d-md-block m-auto">
