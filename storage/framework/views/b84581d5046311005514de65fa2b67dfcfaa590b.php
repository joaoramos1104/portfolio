                        ...
                        <div class="row text-white col p-4">
                            ...
                            <div class="col-12 text-center">
                                ...
                                <div class="collapse text-center" id="collapseEditEducation<?php echo e($educ->id); ?>">
                                    <div class="container">
                                        <form action="/admin/education/<?php echo e(route('update_education', $educ->id)); ?>" method="post">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('PUT'); ?>
                                                <div class="row p-3">
...
unset($__errorArgs, $__bag); ?>" id="password" placeholder="Senha" data-name="cresteUserAdmin" name="password" required autocomplete="new-password">
                        <label for="password">Senha</label>
                    </div>
                    <div class="form-floating">
                        <input type="password" class="form-control bg-secondary text-white" id="password" data-name="cresteUserAdmin" placeholder="Confirmar senha" name="password_confirmation" required autocomplete="new-password">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\portifolio\resources\views//admin/admin.blade.php ENDPATH**/ ?>