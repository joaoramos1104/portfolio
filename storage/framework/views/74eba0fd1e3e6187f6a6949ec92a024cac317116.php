...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus placeholder="Digite o e-mail cadastrado">
            ...
            <div class="col-md-6 col-sm-12 text-center m-auto">
                ...
                <p>Com um click você recupera seu acesso, você receberar um email.</p>
...
<?php echo $__env->make('layout.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\joaor\Área de Trabalho\portifolio\resources\views/auth/passwords/email.blade.php ENDPATH**/ ?>