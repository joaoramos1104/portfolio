...
<body>
    ...
    <script src="<?php echo e(url(mix('js/jquery/jquery.min.js'))); ?>"></script>
            ...
            <script>
                ...
                $("#clianFormAddUser").click(function(){
                    $("[data-name='cleanAddProject']").val('');
                    $("#collapseAddProject").removeClass( "show" );
                });
                $("#clianFormCresteUserAdmin").click(function(){
                    $("[data-name='cresteUserAdmin']").val('');
                });
                $("#clianFormUpdatePasswordAdmin").click(function(){
...
<?php /**PATH D:\xampp\htdocs\portifolio\resources\views/layout/app.blade.php ENDPATH**/ ?>