                ...
                <div class="row col p-3">
                    ...
                    <div class="col-md-6 d-sm-none d-md-block p-3 m-auto">
                        ...
                        <div class="mb-2 text-center">
                            ...
                            <i class="fas fa-phone-square-alt text-color"></i><strong> +55 (21) 98298-2487</strong><a class="nav-link" href="https://api.whatsapp.com/send?phone=5521982982487" target="_blank"><img class="img-fluid" style="width: 30px; text-decoration: none;" src="assets/img/mens.png" alt="..." /><strong>WhatsApp</strong></a>
